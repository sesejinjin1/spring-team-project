            ...
            <li>
                ...
                <div style= "text-align:left;">
                    ...
                    <ul dir="auto">
                        ...
                        <li>후기는 상품을 구매한 회원에게만 작성버튼이 나타나며, 버튼을 누를 시 모달창이 나타나고 사진 첨부와 별점과 함께 후기등록, 수정, 삭제가 가능합니다.</li>
                    </ul>
                ...
                <div style= "text-align:left;">
                    ...
                    <ul dir="auto">
                        ...
                        <li>구매 시 마일리지 사용을 하게되면 적립이 되지않고, 미사용 시 구매금액의 5%가 마일리지로 적립됩니다.</li>
                        <li>결제하기 버튼을 누르게 되면 포트원 결제API를 통해 카드, 카카오페이 등 결제를 진행합니다.</li>
                    </ul>
